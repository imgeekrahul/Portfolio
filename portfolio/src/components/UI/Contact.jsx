                ...
                <div className='md:flex justify-between items-center'>
                    ...
                    {/* {loading ? 
                        ...
                        <form className='w-full' onSubmit={handleSubmit}>
                            ...
                            <button className='w-full p-3 focus:outline-none rounded-[5px] bg-smallTextColor text-white hover:bg-headingColor text-center ease-in duration-300'>{loading ? <BeatLoader color="#fff" /> : "Send Message"}</button>
                        </form>
                    {/* } */}
                    </div>
                </div>
